        ...
        slope = 1; //Height of sawtooth arbitrary decision. Choose 200, so when duty cycle = 50%, sawtooth goes from -100 to 100
        dcOffset = -100; //dcOffset controls duty cycle.
        ...
        function startAudioVisual() {
            ...
            function toggleFlash(timestamp) {
                ...
                triangleValue = Math.abs((slope*(elapsedTime % period)) - slope*period/2) - period/4;
