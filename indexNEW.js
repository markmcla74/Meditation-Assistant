        ...
        let elapsedTime, lastTime, firstPassTime, isFirstLoop, sawtoothValue, animationFrameId, t1, t2, t3, t4, t5, t6, player, isStartButtonPushed;
        t1 = 30000;  // 30 sec
        t2 = 180000; // 3 min
...
function onPlayerReady(event) {
  ...
  //isStartButtonPushed = 1;
  //console.log(isStartButtonPushed);
  );
}
